...
| idfv            | string  | 否   | IOS idfv                                        |
| anid           | string  | 否   | Android ID                                             |
| imei            | string  | 否   | imei                                                        |
| imsi            | string  | 否   | imsi                                                        |
| mac            | string  | 否   | mac 地址，如 00:02:00:00:00:00                                                        |
| ua            | string  | 否   | 浏览器 userAgent                                                        |
| type            | string  | 否   | 设备类型(0 – phone，1 – pad，2 – 其他)                                                        |
| os            | string  | 否   | 操作系统类型(0 – IOS，1 – ANDROID)                                                        |
| osv            | string  | 否   | 操作系统版本，如：10.2.1                                                        |
| brand            | string  | 否   | 设备品牌，如：HUAWEI                                                        |
| model            | string  | 否   | 设备型号，如：MATE9                                                        |
| sw            | string  | 否   | 设备屏幕宽度，像素，如 1080                                                        |
| sh            | string  | 否   | 设备屏幕高度，像素，如 1920                                                   |
| lat            | string  | 否   | 纬度                                                        |
| lon            | string  | 否   | 经度                                                        |
| orientation            | string  |/横竖屏，0–竖屏，1–横屏                                                 |
| mcc            | string  | 否   | 移动国家码，中国：460                                                       |
| mnc            | string  | 否   | 移动网络码，移动 00/02/07，联通 01/06，电信 03/05/11           |
| connection            | string  | 否   | 网络类型：0-未知，1-wifi，2-2G，3-3G，4-4G                                      |
